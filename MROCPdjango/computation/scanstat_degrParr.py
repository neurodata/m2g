...
def calcScanStat_Degree(G_fn, G = None, lcc_fn = None, ssDir = None, degDir = None , N=1):
  '''
...
def main():
    ...
    calcScanStat_Degree(result.G_fn, None, result.lcc_fn, result.ssDir, result.degDir)
