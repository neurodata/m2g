...
def calcScanStat_Degree(G_fn, G = None, lcc_fn = None, roiRootName = None, ssDir = None, degDir = None , N=1):
  ...
  start = time()
  j1 = job_server.submit(popSSarray, (cpu1,G,) , (zeros_like,),("numpy",))
  j2 = job_server.submit(popSSarray, (cpu2,G, ), (zeros_like,),("numpy",)) 
  j3 = job_server.submit(popSSarray, (cpu3,G, ), (zeros_like,),("numpy",))
  j4 = job_server.submit(popSSarray, (cpu4,G, ), (zeros_like,),("numpy",)) 
  
  indSubgrEdgeNum[cpu1[0]:cpu1[-1]] = j1()
  indSubgrEdgeNum[cpu2[0]:cpu2[-1]] = j2()
  indSubgrEdgeNum[cpu3[0]:cpu3[-1]] = j3()
  indSubgrEdgeNum[cpu4[0]:cpu4[-1]] = j4()
...
def popSSarray(rangeNodes, G):
  indSubgrEdgeNum = zeros_like(len(rangeNodes))
