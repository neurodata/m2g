...
def eignTriLocal_MAD(G_fn, G = None, lcc_fn = None, triDir=None, MADdir = None, eigvDir = None, k=None):
  '''
...
def main():
  ...
  eignTriLocal_MAD(result.G_fn, None, result.lcc_fn, result.triDir, result.MADdir, result.eigvDir, result.k )
