...
def eignTriangleLocal(G_fn, G = None, lcc_fn = None, triDir=None, k=None, degradeTest = False):
  '''
...
def main():
  ...
  eignTriangleLocal(result.G_fn, None, result.lcc_fn, result.triDir, result.k )
