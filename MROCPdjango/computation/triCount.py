...
def eignTriangleLocal(G_fn, lcc_fn = None, roiRootName = None, triDir=None, k=None):
  '''
...
def main():
  ...
  eignTriangleLocal(result.G_fn, result.lcc_fn, result.roiRootName,result.triDir, result.k )
