...
def main():
  ...
  parser.add_argument('url', action="store", help='url must be in the form  {project}/{site}/{subject}/ \\			{session}/{scanID}/yes|no, where the last param is either \'yes\' or \'no\', but not both. \
