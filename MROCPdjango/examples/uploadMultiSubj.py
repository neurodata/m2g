...
def main():
  ...
  parser.add_argument('url', action="store", help='url must be http://mrbrain.cs.jhu.edu/disa/upload/{projectName}/{site}/{subject}/{session}/{scanID}/{s|b} where s= smallgraph OR b = biggraph')
