...
def m2g_dwi_worker(
    ...
    init_dirs = gen_utils.make_initial_directories(outdir, dwi, parcellations=parcellations)
    ...
    if not skipeddy:
        init_dirs['dwi_dirs'][1] = gen_utils.as_directory(init_dirs['dwi_dirs'][1], remove=True, return_as_path=True)
