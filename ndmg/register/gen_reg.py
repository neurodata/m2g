    ...
    def t1w2dwi_align(self):
        ...
        if self.simple is False:
            try:
                ...
                mgru.align_nonlinear(self.t1w_brain, self.input_mni, xfm=self.t12mni_xfm_init, out=self.t1_aligned_mni, warp=self.warp_t1w2mni, ref_mask=self.input_mni, conf=self.input_mni_sched)
