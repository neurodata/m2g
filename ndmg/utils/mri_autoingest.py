...
def main():
    ...
    dataset_name='MNI3'        #(type=str, help='Name of Dataset')
    imagesize=(182,218,182)           #(type=int[], help='Image size (X,Y,Z)')
    ...
    project_name='KKI2009_gk2'        #(type=str, help='Name of Project. Has to be unique in OCP. User Defined')
    token_name='KKI2009_gk2'          #(type=str, default='', help='Token Name. User Defined')
