...
class graph(object):
    def __init__(self, N, rois, attr=None, sens="dwi"):
        ...
        **Positional Arguments:**
        ...
        self.parcel_img = nb.load(rois)
        self.rois = self.parcel_img.get_data().astype('int')
    ...
    def make_graph(self, streamlines, attr=None):
        ...
        **Positional Arguments:**
        ...
        self.g, _ = utils.connectivity_matrix(self.tracks, self.rois,
            ...
            symmetric=True)
        self.conn_matrix_filt = self.conn_matrix[1:length(self.n_ids), 1:length(self.n_ids)]
