...
# Email: disa@jhu.edu
#!/bin/bash
echo "Example downloads ./testdata directory from http://openconnecto.me/mrdata/perm/testdata/ ..."
...
then
  ...
  wget --output-document=$FIBER http://openconnecto.me/mrdata/perm/testdata/test_fiber.dat 
fi
...
then
  ...
  wget --output-document=$ROI_RAW http://openconnecto.me/mrdata/perm/testdata/test_roi.raw 
fi
...
then
  ...
  wget --output-document=$ROI_XML http://openconnecto.me/mrdata/perm/testdata/test_roi.xml 
fi
