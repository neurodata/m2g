...
The **ndmg** pipeline has been developed as a one-click solution for human connectome estimation by providing robust and reliable estimates of connectivity across a wide range of datasets. The derivatives are analyzed in our pre-print, available on [BiorXiv](https://www.biorxiv.org/content/early/2018/04/24/188706). The pipelines are explained in the [documentation](https://ndmg.neurodata.io/).
