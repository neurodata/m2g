...
### Diffusion Pipeline
The organization of the output files generated by the m2g-d pipeline are shown below. If you only care about the connectome edgelists (**m2g**'s fundamental output), you can find them in `/output/connectomes`.
...
/output
    ...
    /qa_d
        ...
        /reg
            ...
            t1w_corpuscallosum_dwi_2_nodif_B0_bet.png = 
            t1w_csf_mask_dwi_2_nodif_B0_bet.png =
            t1w_gm_in_dwi_2_nodif_B0_bet.png =
            t1w_in_dwi_2_nodif_B0_bet.png =
            t1w_vent_mask_dwi_2_nodif_B0_bet.png = 
            t1w_wm_in_dwi_2_nodif_B0_bet.png = 
        /skull_strip
...
## Functional Pipeline
The organization of the output files generated by the m2g-f pipeline are shown below. If you only care about the connectome edgelists (**m2g**'s fundamental output), you can find them in `/output/dwi/roi-connectomes`.
