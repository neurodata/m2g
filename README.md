...
## Outputs
The organization of the output files generated by the **ndmg** pipeline are shown below.
If you only care about the connectome edgelists (**ndmg**'s fundamental output), you can find them in `/output/dwi/roi-connectomes`.
```
